  ...
  return (
    <div className="rounded-md border border-border bg-bg-muted p-4 overflow-x-auto">
      <svg
        viewBox="0 0 760 260"
        role="img"
        aria-label="Data flow from payer denial intake through ingest, PHI minimization, BAA-gated model serving, payer-policy rules, human review, and back out as an appeal or corrected claim"
      ...
      >
        ...
        {/* Payer / clearinghouse */}
        <Node x={20} y={100} w={90} h={50} title="Payer / CH" sub="835 · EOB · appeal" />

        {/* Ingest */}
        <Node x={140} y={60} w={110} h={50} title="Ingest gateway" sub="TLS, validate" />

        {/* PHI minimization */}
        <Node x={280} y={60} w={120} h={50} title="PHI minimization" sub="strip member, MRN" />
        ...
        {/* Rule engine */}
        <Node x={580} y={60} w={70} h={50} title="Rules" sub="CARC · policy" />

        {/* Reviewer */}
        <Node x={430} y={170} w={130} h={50} title="Human reviewer" sub="review · edit · submit" />
